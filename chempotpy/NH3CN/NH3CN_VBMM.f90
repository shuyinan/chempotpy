...
C   Notes:
C
C   Reference:  J. Espinosa-Garcia, C. Rangel, M. Garcia-Chamorro and 
C   J.C. Corchado, Molecules, 26, 994 (2021) 
C
C   PES without vop. CONST: CONST-24    
...
C                       X(13) - X(15) : X, Y, Z for C (Hb)
C                       X(16) - X(18) : X, Y, Z for N 
C
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C
      CHARACTER*75 REF(5)
...
C
     ...
     +               NASURF(ISURF+1,ISURF+1),NDER
C
      COMMON /POTCM/ nnc,nnb,nnh(4),nno,
...
C CONST-40
       ...
       DATA fkh2oeq /   0.2800000d0/
       DATA alph2o  /   0.7250d0/
       DATA angh2oeq /  180.0000d0/
       DATA a3cb     /  1.60d0/
       DATA b3cb     /  0.011d0/
