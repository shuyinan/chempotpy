...
1000  FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',                
     *      //,1X,T5,'FH2 5SEC-C2 potential energy surface',                    
     2       /,1X,T20,'a = 0.09, b = 0.1, c = 6.0, d = 4.0')                    
...
51    CONTINUE                                                                  
      ...
      RSC    = (6.0D0 - R(2)) / 4.0D0                                           
      DSC    = 1.0D0 - RSC*RSC                                                  
      IF (R(2) .GT. 2.0D0 .AND. R(2) .LT. 10.0D0) THEN                          
          TSCALE(2) = 1.0D0+ASC1*EXP(-ASC2/DSC)                                 
          IF (NDER .EQ. 1)                                                      
     1        DTSCLE(2,2) = ASC1*EXP(-ASC2/DSC)*                                
     2                      (ASC2*2.0D0*RSC*0.25D0/(DSC*DSC))                   
      ENDIF                                                                     
C                                                                               
