...
C   Common name:        6SEC                                                    
C   Reference:          S. L. Mielke, G. C. Lynch,                              
C                       D. G. Truhlar, and D. W. Schwenke                       
C                       Chem. Phys. Lett. 216, 441-446 (1993)                   
C
...
C   with respect to the coordinates are passed through the common block PT1CM:  
...
C     A=ALPH0/DBLE(N)**ALPH1        N=6,8,10                                    
C     B=BET0*EXP(-BET1*DBLE(N))     N=6,8,10                                    
C                                                                               
...
1100  FORMAT(/,2X,T5,'Potential parameters',/,                                  
     1       /,2X,T5,'c1 = 0.103, c2 = 2.0, and c3 = 0.38',                     
...
C                                                                               
       ...
       REF(3)='Chem. Phys. Lett. 216, 441(1993)'                                
C                                                                               
      INDEXES(1) = 9                                                            
      INDEXES(2) = 1                                                            
      INDEXES(3) = 1                                                            
...
C                                                                               
C============================================================================== 
C   POT: Subroutine for computing the energy and the derivatives.               
C============================================================================== 
C                                                                               
      SUBROUTINE POT                                                            
C                                                                               
...
C                                                                               
C                                                                               
C   Test the values of Ri                                                       
C   If the values are unrealistic then print Ri and exit                        
C                                                                               
      DO 11 I=1,3                                                               
            RTMP(I) = R(I)                                                      
11     CONTINUE                                                                 
      DO 12 I1=1,3                                                              
            ...
            T = R(I2) + R(I3)                                                   
            IF(R(I1) .GT. T)THEN                                                
               WRITE(NFLAG(18),100) R(I1),R(I2),R(I3)                           
               STOP                                                             
            ENDIF                                                               
12     CONTINUE                                                                 
100    FORMAT(//,10X,'R1 = ',1PE20.10,5X,'R2 = ',1PE20.10,5X,                   
     1               'R3 = ',1PE20.10)                                          
C                                                                               
...
C                                                                               
      ...
      DATA NATOMS /3/                                                           
C                                                                               
      DATA DISSE /0.224989333D0, 0.174472692D0, 0.224989333D0/                  
C                                                                               
