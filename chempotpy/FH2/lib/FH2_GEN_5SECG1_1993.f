...
C      N.B.: R(1),[R(FH)], must be at least 50 a.u. for the energy to be zero   
C                                                                               
C                                                                               
C   Parameters:                                                                 
...
C                                                                               
C   Echo the potential name and parameters to the                               
...
1000  FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',                
     *      //,1X,T5,'FH2 5SEC-G1potential energy surface',                     
     *       /,1X,T5,'SCALE = 1.10, a = 0.10, b = 2.0, R0 = 2.485')             
...
51    CONTINUE                                                                  
      ...
      ASC3   = 2.00D0                                                           
      TMP1   = (R(2) - 2.485D0)                                                 
      TMP2   = EXP(-ASC3*TMP1*TMP1)                                             
      TSCALE(2) = ASC1 - ASC2*TMP2                                              
      IF (NDER .EQ. 1)                                                          
     1    DTSCLE(2,2) = -ASC2*TMP2*(-ASC3*2.0D0*TMP1)                           
C                                                                               
