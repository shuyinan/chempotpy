...
C   Common name:     5SEC-W                                                     
C   References:      G. C. Lynch, P. Halvick, M. Zhao, D. G. Truhlar,           
C                    C.-h. Yu, D. J. Kouri, and D. W. Schwenke                  
C                    J. Chem. Phys. 94, 7150-7158 (1991)                        
C
...
600   FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',/,              
     *       /,1X,T5,'FH2 5SECW potential energy surface',                      
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='G. C. Lynch, P. Halvick, M. Zhao, D. G. Truhlar,'                
       REF(2)='C.-h. Yu, D. J. Kouri, D. W. Schwenke'                           
       REF(3)='J. Chem. Phys. 94, 7150(1991)'                                   
C                                                                               
      INDEXES(1) = 9                                                            
      INDEXES(2) = 1                                                            
      INDEXES(3) = 1                                                            
...
C                                                                               
      ...
      DATA NATOMS /3/                                                           
C                                                                               
      DATA XHF /2.297037D0, 0.359790D0, -0.148502D0/                            
      DATA XHH /-0.336349D0, 0.119602D0, -0.006173D0/                           
      DATA P  /-0.171730D0, -0.031965D0, -0.201948D0, -0.095972D0/              
      DATA C3C, ALFP /0.327847D0, 0.081831D0/                                   
C                                                                               
