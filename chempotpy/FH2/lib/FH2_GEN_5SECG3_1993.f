...
C                                                                               
C   Echo the potential name and parameters to                                   
C   the file linked to UNIT NFLAG(18)                                           
C                                                                               
...
1000  FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',                
     *      //,1X,T5,'FH2 5SEC-GM3 potential energy surface',                   
     *       /,1X,T5,'SCALE = 1.0, a = 0.15, b = 1/sqrt(.32), R0 = 2.0')        
