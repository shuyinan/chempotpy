...
C   Common name:     PK2                                                        
C   Reference:       A. Persky and H. Kornweitz                                 
C                    J. Phys. Chem. 91, 5496 (1987)                             
C                                                                               
C   Calling Sequence:                                                           
...
C        EASYBC and EASYAC represent the energies in the HCl and the ClCl       
...
600   FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',                
     *      //,1X,T5,'ClHCl PK2 potential energy surface',                      
     *      //,1X,T5,'Parameters:',                                             
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='A. Persky and H. Kornweitz'                                      
       REF(2)='J. Phys. Chem. 91, 5496(1987)'                                   
C                                                                               
      INDEXES(1) = 17                                                           
      INDEXES(2) = 1                                                            
      INDEXES(3) = 17                                                           
...
6000  FORMAT(/,2X,'In the ClHCl PK2 potential, T, RAD = ',1P,2E15.7,            
...
C                                                                               
         ...
         DATA Z    / 0.166D0, 0.166D0, -0.098D0/                                
C                                                                               
         END                                                                    
C                                                                               
C*****                                                                          
