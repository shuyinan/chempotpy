...
C   System:           HCl2                                                      
C                                                                               
C   Functional form:  LEP (London-Erying-Polyani)                               
C                                                                               
...
C   energy of the Cl "infinitely" far from the HCl diatomic, with the           
C   HCl diatomic at its equilibrium configuration.  Similarly, the terms        
C   EASYBC and EASYAC represent the Cl2 and the HCl asymptotic valleys,         
C   respectively.                                                               
...
C   infinitely far from the equilibrium Cl2 diatomic.                           
C                                                                               
...
C                                                                               
100   FORMAT (/, 2X, T5, 'PREPOT has been called for HCl2 ',                    
     *                   'potential - LEP functional form',                     
     *        //, 2X, T5, 'Potential energy surface parameters:',               
     *        /, 2X, T5, 'Bond', T46, 'H-Cl', T57, 'Cl-Cl', T68, 'Cl-H',        
...
C                                                                               
         DATA DE/ 106.6772D0, 58.04293D0, 106.6772D0/                           
         DATA RE/ 1.2732D0, 1.99976D0, 1.2732D0/                                
         DATA BETA/ 1.86932D0, 2.00802D0, 1.86932D0/                            
