...
C                                                                               
       ...
       REF(3)='J. Chem. Phys. 44, 1168(1966) [Functional Form]'                 
C                                                                               
      INDEXES(1) = 53                                                           
      INDEXES(2) = 1                                                            
      INDEXES(3) = 1                                                            
...
C   System:          ABC                                                        
C   Functional form: Extended-LEPS (London-Erying-Polyani-Sato)                 
C   Reference:       P. J. Kuntz, E. M. Nemth, J. C. Polanyi,                   
C                    S. D. Rosner, and C. E. Young                              
C                    J. Chem. Phys. 44, 1168 (1966)                             
C                                                                               
...
C                                                                               
         ...
         DATA RE/ 1.604D0, 0.7417D0, 1.604D0/                                   
         DATA BETA/ 1.75D0, 1.942D0, 1.75D0/                                    
         DATA Z/ 0.0915D0, 0.225D0, 0.0915D0/                                   
C                                                                               
         END                                                                    
C                                                                               
C*****                                                                          
