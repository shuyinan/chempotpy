...
C                                                                               
C   System:          F2H2                                                       
C   Common name:     SQSBDE                                                     
C   Number of derivatives: 0                                                    
C   Number of bodies: 4                                                         
C   Number of electronic surfaces: 1                                            
C   Interface:       potlib2001
                                                                                
C   References:      M. Quack, M. Suhm Mol. Phys. 69 (1990) P791                
...
C --TH1,TH2,TAU IN DEGREES                                                      
C DEFINITION AS IN QUACK+SUHM MOL.PHYS. 69 (1990) P791                          
C OUTPUT : HF DIMER (SQSBDE) POTENTIAL ENERGY IN CM-1                           
C                                                                               
...
C                    Rijks and Wormer J. Chem. Phys. 90(1989) 6507              
       ...
       REF(1)='M. Quack, M. Suhm, Mol. Phys. 69, P791(1990)'                    
       REF(2)='Kofranek et al., Chem. Phys. 121, 137(1988)'                     
       REF(3)='Rijks and Wormer, J. Chem. Phys. 90, 6507(1989)'                 
C                                                                               
      INDEXES(1) = 1                                                            
      INDEXES(2) = 9                                                            
      INDEXES(3) = 1                                                            
...
C                                                                               
     ...
     *     exp(-((10.5d0-rcm)/rcm)**2)                                          
      ...
      if(rcm.lt.11.5d0) then                                                    
         ...
         e=e+(vp(3,1,4)+vp(1,3,4))*a(8)/rcm**5*exp(-((11.5-rcm)/rcm)**2)        
      else                                                                      
...
C monomer terms                                                                 
C                                                                               
      e=e+47635d0*(1.0d0-a(19)*exp(-0.1d0*(r23-3.0d0)**2))*                     
     *         (1.0d0-exp(-1.1953d0*                                            
     ...
     *                                        ))))**2                           
      e=e+47635d0*(1.0d0-a(19)*exp(-0.1d0*(r14-3.0d0)**2))*                     
     *         (1.0d0-exp(-1.1953d0*                                            
...
C     IN CM-1 IN THE ICP REFERENCE.                                             
C                                                                               
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)                                       
C                                                                               
      CHARACTER*75 REF(5)                                                       
...
C                                                                               
      ...
      DATA A(5),DA(5)  / -1736693.09500000D0,   0.0D0/                          
      DATA A(6),DA(6)  / -4416487.722000003D0,  0.0D0/                          
      DATA A(7),DA(7)  / 16012389.5100000D0,    0.0D0/                          
      DATA A(8),DA(8)  / -6389444.85500000D0,   0.0D0/                          
      DATA A(9),DA(9)  / -866.867375551329D0,   117.589789927560D0/             
      DATA A(10),DA(10)  / 129789.363470169D0,  1937.56316874928D0/             
      DATA A(11),DA(11)  / 0.0D0,  0.0D0/                                       
      DATA A(12),DA(12)  / 0.0D0,  0.0D0/                                       
      DATA A(13),DA(13)  / 2622184.75665877D0,  29726.6301460444D0/             
      DATA A(14),DA(14)  / 0.0D0,  0.0D0/                                       
      DATA A(15),DA(15)  / 0.0D0,  0.0D0/                                       
      DATA A(16),DA(16)  / 0.0D0,  0.0D0/                                       
      DATA A(17),DA(17)  / 184254701843.311D0,  17553092934.4463D0/             
      DATA A(18),DA(18)  / -320000.0D0,         0.0D0/                          
      DATA A(19),DA(19)  /  3.326438943860246D-2,  1.353645657747023D-3/        
      DATA A(20),DA(20)  / -4.576887206887037D-3,  1.865017706495822D-4/        
      DATA A(21),DA(21)  /  0.409730666039653D0,   2.777020547964313D-2/        
      DATA A(22),DA(22)  /  32623551943283.8D0,    3630087056915.05D0/          
      DATA A(23),DA(23)  / 0.0D0,  0.0D0/                                       
      DATA A(24),DA(24)  / 71754497894201.8D0,    2525041881368.02D0/           
      DATA A(25),DA(25)  / 0.0D0,  0.0D0/                                       
      DATA A(26),DA(26)  / 5.032387872479119D-2,  1.860431838521344D-3/         
      DATA A(27),DA(27)  / 1.46832057915281D0,    9.713248031677595D-2/         
      DATA A(28),DA(28)  / 3384.63155928653D0,    85.5567822945890D0/           
      DATA A(29),DA(29)  / 0.0D0,  0.0D0/                                       
      DATA A(30),DA(30)  / 0.0D0,  0.0D0/                                       
      DATA A(31),DA(31)  / -160267.101272529D0,   4055.33877671770D0/           
      DATA A(32),DA(32)  / 0.0D0,  0.0D0/                                       
      DATA A(33),DA(33)  / 0.0D0,  0.0D0/                                       
      DATA A(34),DA(34)  / 0.0D0,  0.0D0/                                       
      DATA A(35),DA(35)  / 0.0D0,  0.0D0/                                       
      DATA A(36),DA(36)  / -16268.8946598104D0,   541.139677344219D0/           
      DATA A(37),DA(37)  / 0.0D0,  0.0D0/                                       
      DATA A(38),DA(38)  / 0.0D0,  0.0D0/                                       
      DATA A(39),DA(39)  / 2802.57610197247D0,    56.8038283168248D0/           
      ...
      DATA A(46),DA(46)  / 2860.06394339599D0,    44.3633384808498D0/           
      ...
      DATA A(52),DA(52)  / 509.102022118840D0,    18.7375880046217D0/           
      ...
      DATA A(84),DA(84)  / -644.815083021031D0,   18.1151965381963D0/           
      ...
      DATA A(101),DA(101)  / 22530.9324112547D0,   989.768118754483D0/          
      DATA A(102),DA(102)  / 1630.40722103571D0,   111.781936229583D0/          
      DATA A(103),DA(103)  / 0.0D0,  0.0D0/                                     
      DATA A(104),DA(104)  / 1042.90771467500D0,   18.4325305864792D0/          
      DATA A(105),DA(105)  / -366.368726725276D0,  12.8434812694663D0/          
      DATA A(106),DA(106)  / 2428.17244795167D0,   246.109466713404D0/          
      DATA A(107),DA(107)  / -1882.37787794149D0,  70.8301781102542D0/          
      DATA A(108),DA(108)  / 0.0D0,  0.0D0/                                     
      DATA A(109),DA(109)  / 0.0D0,  0.0D0/                                     
      DATA A(110),DA(110)  / -326.002341194829D0,  19.3580274207174D0/          
      DATA A(111),DA(111)  / 0.0D0,  0.0D0/                                     
      DATA A(112),DA(112)  / 0.0D0,  0.0D0/                                     
      DATA A(113),DA(113)  / 116.704136523402D0,   11.3452311839242D0/          
      DATA A(114),DA(114)  / 0.0D0,  0.0D0/                                     
      DATA A(115),DA(115)  / 572.632667044664D0,   33.6908429103859D0/          
