...
C   Common name:     ClH2 DIM-3C                                                
C   Reference:       I. Last and M. Baer                                        
C                    Chem. Phys. Lett. 73, 514 (1980)                           
C                    J. Chem. Phys. 75, 288 (1981)                              
C                                                                               
C   Calling Sequence:                                                           
...
600   FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',                
     *      //,1X,T5,'ClH2 DIM-3C potential energy surface',                    
     *      //,1X,T5,'Parameters:',                                             
     ...
     *        /,1X,T5,'HCl parameters (atomic units):',                         
     *        /,1X,T10,'RHCl',T16,'=',T18,1PE13.5,                              
     *             T40,'AHCl',T46,'=',T48,1PE13.5,                              
     *        /,1X,T10,'DHCl',T16,'=',T18,1PE13.5,                              
     *             T40,'BHCl',T46,'=',T48,1PE13.5)                              
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='I. Last and M. Baer'                                             
       REF(2)='Chem. Phys. Lett. 73, 514(1980)'                                 
       REF(3)='J. Chem. Phys. 75, 288 (1981)'                                   
C                                                                               
      INDEXES(1) = 17                                                           
      INDEXES(2) = 1                                                            
      INDEXES(3) = 1                                                            
...
C                                                                               
      ...
      CALL CARTTOR                                                              
C                                                                               
C   The potential routines define R1=R(Cl-H), R2=R(H-Cl), and R3=R(H-H);        
...
C                                                                               
      ...
      DH3(8) = -DH3(4)                                                          
C                                                                               
C  CHECK IF H IS ALREADY DIAGONAL                                               
C                                                                               
      DO 1112 J = 2,4                                                           
      JM = J - 1                                                                
      DO 1112 I = 1,JM                                                          
      INDEX =(J*(J-1))/2 + I                                                    
      IF(ABS(H(INDEX)).GT.1.D-30) GO TO 1113                                    
 1112 CONTINUE                                                                  
      E(1) = H(1)                                                               
      DO 1118 J = 2,4                                                           
      JJ = (J*(J+1))/2                                                          
...
C                                                                               
        ...
        DATA RHH, AHH, DHH, BHH /1.4016D0, 1.0291D0, 0.17445D0, 0.018D0/        
        DATA XIH, XIX, G, ALFW  /1.D0,     2.033D0,  0.33D0,    1.0D0/          
        DATA RHX /2.409D0/                                                      
        DATA AHX /0.986D0/                                                      
        DATA DHX /0.1696D0/                                                     
        DATA BHX /0.013D0/                                                      
      ...
      END                                                                       
C                                                                               
C   Eispack routines needed by this potential                                   
C                                                                               
