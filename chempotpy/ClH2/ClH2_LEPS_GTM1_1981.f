...
!   Common name:      surface no. 1
!   Reference:        B. C. Garrett, D. G. Truhlar, and A. W. Magnuson
!                     J. Chem. Phys. 74, 1029 (1981)
!
!   Calling Sequence: 
...
!
!   Zero of energy: 
!      The classical potential energy is set equal to zero for the Cl
...
!
!   Coordinates:
!      Internal, Definition: R(1) = R(Cl-H)
!                            R(2) = R(H-H)
!                            R(3) = R(Cl-H)
!
...
900   FORMAT(/,1X,T5,'Error: POT has been called with NDER = ', I5,
     ...
     *                'coded in this potential')
      ...
      END
         ...
         DATA Z/ 0.182D0, 0.187D0, 0.182D0/
         END
