...
C   Common name:      surface no. 3
C   Reference:        B. C. Garrett, D. G. Truhlar, and A. W. Magnuson
C                     J. Chem. Phys. 74, 1029 (1981)
C
C   Calling Sequence: 
...
C   kcal/mol, and the lengths are in Angstroms.
         ...
         DATA Z/ 0.1445D0, 0.225D0, 0.1445D0/
C
         END
C*****
      SUBROUTINE POTINFO
