...
C   energy of the I "infinitely" far from the IH diatomic, with the             
C   IH diatomic at its equilibrium configuration.  Similarly, the terms         
C   EASYBC and EASYAC represent the HI and the I2 asymptotic valleys,           
C   respectively.                                                               
...
C   infinitely far from the equilibrium HI diatomic.                            
C                                                                               
...
C                                                                               
100   FORMAT (/, 2X, T5, 'PREPOT has been called for IHI ',                     
     *                   'potential surface A ',                                
     *        /, 2X, T5, 'LEPS functional form',                                
     *        //, 2X, T5, 'Potential energy surface parameters:',               
     *        /, 2X, T5, 'Bond', T47, 'I-H', T58, 'H-I', T69, 'I-I',            
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='P. J. Kuntz, E. M. Nemeth, J. C. Polanyi,'                       
...
C   System:          ABC                                                        
C   Functional form: Extended-LEPS (London-Erying-Polyani-Sato)                 
C   References:      P. J. Kuntz, E. M. Nemeth, J. C. Polanyi,                  
C                    S. D. Rosner, and C. E. Young                              
C                    J. Chem. Phys. 44, 1168-1184 (1966)                        
C                                                                               
...
C   kare in cal/mol, and the lengths are in Angstroms.                          
C                                                                               
         DATA DE/ 76.8D0, 76.8D0, 35.9D0/                                       
         DATA RE/ 1.6D0, 1.6D0, 2.67D0/                                         
         DATA BETA/ 1.75D0, 1.75D0, 1.86D0/                                     
         DATA Z/ 0.2D0, 0.2D0, 0.125D0/                                         
C                                                                               
         END                                                                    
C                                                                               
C*****                                                                          
