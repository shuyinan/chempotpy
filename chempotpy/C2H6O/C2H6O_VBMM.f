C**********************************************************************
C   System:                     C2H6O
C   Common name:                C2H6+O
C   Number of derivatives:      1
C   Number of bodies:           9
C   Number of electronic surfaces: 1
C   Interface: potlib2001
C
C   References:: J. Espinosa-Garcia, C. Rangel, J.C. Corchado and 
C   M. Garcia-Chamorro, PCCP, 22, 22591 (2020)
C
C************************************************************************
...
C*************************************************************************
      SUBROUTINE POT
C
C   System:    C2H6 + O --> C2H5 + HO. 
C              Joaquin Espinosa-Garcia Junio 2020
C              Basada en la PES H + C2H6 REv-2019 para RPMD.
C
C              
...
C JEG 2019. cambios por problemas en RPMD de F,Cl,H + C2H6!!
       s3(4)=1.0d0
       s3(8)=1.0d0
C JEG 2019 
c
...
C CONST-6 final. Junio de 2020 !!!!
       ...
       DATA w3    /   1.00000d0/
       DATA w4    /   1.08897d0/
       DATA d1c1h    / 129.23000d0/
       DATA d3c1h    /  36.00400d0/
       ...
       DATA w5    /   1.00000d0/
       DATA w6    /   1.08897d0/
       DATA d1c2h    / 129.23000d0/
       DATA d3c2h    /  36.00400d0/
       DATA a1c2h    /   1.60300d0/
       ...
       DATA a2c     /   0.94900d0/
       DATA r0hh    /   0.97101d0/
       DATA d1hh    / 127.45800d0/
       DATA d3hh    /  40.36400d0/
       DATA ahh     /   2.10400d0/
       DATA r0cb    /   1.77097d0/
       DATA d1cb    /  48.20900d0/
       DATA d3cb    /  15.66000d0/
       DATA acb     /   1.3290285d0/
