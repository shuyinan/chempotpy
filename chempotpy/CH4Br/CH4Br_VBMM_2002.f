...
C Functional form:
C Common name:     
C Reference  :     J. Espinosa-Garcia, J. Chem. Phys., Vol. 117, 2076 (2002).
C
C Number of bodies: 6
C Number of electronic states: 1
C Number of derivatives: 0
C Interface: Section-2
C Data file:  CONST.dat
C
C Notes:  CH4+Br based on the surface by
...
C
C         CH4+Br based on the surface by
C         Jordan and Gilbert, JCP, 102, 5669 (1995).
C         JEG, 2002 
C
...
C
c  include file for CH4Br PES

       common /angles/ theta0(4,4),dtheta0(4,4,4)
       common /bonds/ rcb,rch(4),r0ch,rbh(4),r0hh,r0cb
...
c
 ...
 10   CONTINUE
C
c  read the parameters for a leps-type pes for the
c  reaction ch4+Br -> ch3 + Brh from the input file CONST
c
       file_path1 = trim(path)//"/CH4Br/CONST.dat"
