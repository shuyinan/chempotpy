***********************************************************************
C   System:                     C2H6H
C   Common name:                C2H6+H
C   Number of derivatives:      1
C   Number of bodies:           9
C   Number of electronic surfaces: 1
C   Interface: potlib2001
C
C   References:: J. Espinosa-Garcia, M. Garcia-Chamorro, and J. C. Corchado,
C                Phys. Chem. Chem. Phys. 2019, 21, 13165 (original fit)
C                J. Espinosa-Garcia, M. Garcia-Chamorro, J. C. Corchado,
C                S. Bhowmick, and Y. V. Suleimanov, Phys. Chem. Chem. Phys. 
C                2020, 22, 13790 (revised fit)
C
***********************************************************************
...
C CONST-62
       ...
       DATA a2c     /   0.94900d0/
       DATA r0hh    /   0.74241d0/
       DATA d1hh    / 109.85800d0/
       DATA d3hh    /  40.56400d0/
       DATA ahh     /   1.95570d0/
       DATA r0cb    /   1.09397d0/
       DATA d1cb    /  46.60900d0/
       DATA d3cb    /  15.10000d0/
       DATA acb     /   1.1890285d0/
...
C     WRITE(NFLAG(18),96)
      ...
      DO I = 1,ISURF+1
         ...
         ENDDO
      ENDDO
C     WRITE(NFLAG(18),101) MSURF,KMAX-1
101   FORMAT(2x,' MAX. AND ACTUAL NO. OF EXCITED SURFACES: ',I3,5x,I3)
      ...
      DO I = 1,ISURF
         ...
         ENDDO
      ENDDO
C     WRITE(NFLAG(18),103) MDER,NDER
