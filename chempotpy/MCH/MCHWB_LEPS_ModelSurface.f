     ...
     *          +(x(1,3)-x(3,3))**2)
      ...
      dudr(1,1,:)=de_u11(:,1)*27.211386
      dudr(1,2,:)=de_u12(:,1)*27.211386
      dudr(2,1,:)=de_u12(:,1)*27.211386
      dudr(2,2,:)=de_u22(:,1)*27.211386
c      dudr(1,1,:)=de_u11(:,1)*51.422067
c      dudr(1,2,:)=de_u12(:,1)*51.422067
c      dudr(2,1,:)=de_u12(:,1)*51.422067
c      dudr(2,2,:)=de_u22(:,1)*51.422067
