...
C   Interface:        potlib200
C   Common name:      NH4
C   Notes:
C
C   References: J. C. Corchado, J. Espinosa-Garcia, J. Chem. Phys.,
C               Vol. 106, p. 4013, 1997.
C
...
c*************************************************************************
c
       subroutine calcdelta(i,j,k,sum2,sum4)
c
...
C
       ...
       END DO
C
       REF(1)='J. C. Corchado and J. Espinosa-Garcia'
       REF(2)='J. Chem. Phys., Vol. 106, p. 4013, 1997'
C
      INDEXES(1) = 1
      INDEXES(2) = 7
      INDEXES(3) = 1
...
C
       ...
       DATA d1ch    / 115.458d0/
       DATA d3ch    /  48.002d0/
       DATA a1ch    /   2.270210d0/
       DATA b1ch    /  -0.401998d0/
       DATA c1ch    /   2.999800d0/
       DATA r0hh    /   0.74191d0/
       DATA d1hh    / 109.458d0/
       DATA d3hh    /  42.596d0/
       DATA ahh     /   1.9457d0/
       ...
       DATA d1cb    /  50.453d0/
       DATA d3cb    /  15.911d0/
       DATA acb     /   1.3009012d0/
       DATA a3s     /   1.0897001d0/
       DATA b3s     /  -0.8088000d0/
       DATA aphi    /   0.2115781d0/
       DATA bphi    /   0.4336958d0/
       DATA cphi    /   1.7508321d0/
       DATA atheta  /   0.7526130d0/
       DATA btheta  /   0.6197119d0/
       DATA ctheta  /   1.2100210d0/
       DATA fch3    /  -0.0520200d0/
       DATA hch3    /  -0.0510900d0/
       DATA fkinf   /   0.6402176d0/
       DATA ak      /   0.0520105d0/
       DATA bk      /   0.1145600d0/
       DATA aa1     /  20.069420d0/
       DATA aa2     /   5.008463d0/
       DATA aa3     /   0.097621d0/
       DATA aa4     /   5.432432d0/
       DATA tau     /   1.8622630d0/
       DATA taunh2  /   1.8046704d0/
       DATA optau   /   1.1847670d0/
C
       END
