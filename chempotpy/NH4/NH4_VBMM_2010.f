...
C   Notes:
C
C   Reference: J. Espinosa-Garcia and J.C. Corchado 
C              J.Phys.Chem. A, 114, 4455 (2010)
...
C
       ...
       DATA d1ch    / 116.458d0/
       DATA d3ch    /  49.002d0/
       DATA a1ch    /   2.160210d0/
       DATA b1ch    /  -0.161998d0/
       DATA c1ch    /   22.99980d0/
       DATA r0hh    /   0.74191d0/
       DATA d1hh    / 111.458d0/
       DATA d3hh    /  42.596d0/
       DATA ahh     /   1.9607d0/
       ...
       DATA d1cb    /  46.253d0/
       DATA d3cb    /  12.241d0/
       DATA acb     /   1.2959012d0/
       DATA a3s     /   0.1897001d0/
       DATA b3s     /  +2.0088000d0/
       DATA aphi    /   0.1715781d0/
       DATA bphi    /   0.2836958d0/
       DATA cphi    /   1.7508321d0/
       DATA atheta  /   0.7526130d0/
       DATA btheta  /   0.6197119d0/
       DATA ctheta  /   1.2100210d0/
       DATA fch3    /  -0.0200200d0/
       DATA hch3    /  -0.0200900d0/
       DATA fkinf   /   0.6002176d0/
       DATA ak      /   0.0120105d0/
       DATA bk      /   0.1145600d0/
       DATA aa1     /   5.069420d0/
       DATA aa2     /   0.008463d0/
