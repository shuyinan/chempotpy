...
C   energy of the F "infinitely" far from the HF diatomic, with the             
C   HF diatomic at its equilibrium configuration.  Similarly, the terms         
C   EASYBC and EASYAC represent the F2 and the HF asymptotic valleys,           
C   respectively.                                                               
...
C   infinitely far from the equilibrium F2 diatomic.                            
C                                                                               
C   The flags that indicate what calculations should be carried out in          
C   the potential routine are passed through the common block PT3CM:            
C   where:                                                                      
...
C                                                                               
100   FORMAT (/, 2X, T5, 'PREPOT has been called for HF2 ',                     
     *                   'potential - extended LEPS functional form',           
     *        //, 2X, T5, 'Potential energy surface parameters:',               
     *        /, 2X, T5, 'Bond', T47, 'H-F', T58, 'F-F', T69, 'F-H',            
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='P. J. Kuntz, E. M. Nemth, J. C. Polanyi,'                        
       REF(2)='S. D. Rosner, C. E. Young'                                       
       REF(3)='J. Chem. Phys. 44, 1168(1966)'                                   
C                                                                               
      INDEXES(1) = 1                                                            
      INDEXES(2) = 9                                                            
      INDEXES(3) = 9                                                            
...
C   PT1CM, ASYCM, PT3CM, SATOCM, and LEPSCM.                                    
...
C                                                                               
C   Compute the derivatives of the energy with                                  
...
C                                                                               
         DATA DE/ 141.1290D0, 37.5884D0, 141.1290D0/                            
         DATA RE/ 0.9171D0, 1.4180D0, 0.9171D0/                                 
         DATA BETA/ 2.2190D0, 2.9200D0, 2.2190D0/                               
         DATA Z/ 0.0D0, -0.35D0, 0.0D0/                                         
C                                                                               
         END                                                                    
C                                                                               
C*****                                                                          
