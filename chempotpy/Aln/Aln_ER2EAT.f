...
C   System:                        Aln
C   Functional form:               Extended Rydberg plus the Extended Axilrod-Teller term
C   Common name:                   ER2+EAT
...
c  maxatom --- maximal number of atoms
      ...
      b1 = 569.076697606  / (autoev*autoang**9)
      b2 = 5.0219833903273/ (autoev*autoang**11)
      au23 = 0.164763067904250132E-01
