...
c  maxatom --- maximal number of atoms (input)
      ...
      de = 12.933d0 / autokpm
      a0 = 0.5282d0 * autoang
      a2 = 4.390d-3 * autoang**3
      a3 = 5.109d0  * autoang**4

      v=0.d0
c     calculate energy of two-body interaction
      do 2 i=1,natom-1
      do 3 j=i+1,natom
      dx=x(i)-x(j)
      dy=y(i)-y(j)
      ...
      dr = rr-re
      aa = a0 + a2*dr**2 + a3*dr**3
      xmorse = de*(1.d0-dexp(-aa*dr))**2-de
      v=v+xmorse
    3 continue
    2 continue
