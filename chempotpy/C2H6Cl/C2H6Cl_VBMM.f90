***********************************************************************
C   System:                     C2H6Cl
C   Common name:                C2H6+Cl
C   Number of derivatives:      1
C   Number of bodies:           9
C   Number of electronic surfaces: 1
C   Interface: potlib2001
C
C   References:: C. Rangel and J. Espinosa-Garcia, Phys. Chem. Chem. 
C                Phys. 2018, 20, 3925 (original fit)
...
*************************************************************************
      SUBROUTINE POT
C
C   System:    C2H6 + X --> C2H5 + HX. 
C              Cipriano Rangel and Joaquin Espinosa-Garcia 2008
C
C              
...
C CONST-62
       ...
       DATA a2c     /   0.94900d0/
       DATA r0hh    /   1.27191d0/
       DATA d1hh    / 107.85800d0/
       DATA d3hh    /  28.56400d0/
       DATA ahh     /   1.85570d0/
       DATA r0cb    /   1.95397d0/
       DATA d1cb    /  46.60900d0/
       DATA d3cb    /  14.90000d0/
       DATA acb     /   1.2290285d0/
