!********************************************************************** 
!   System:                     NO2
!   Name of this surface:       NO2_4Ap_MB-PIP-MEG
...
! order of data: OO,NO,NO,NO,NO,NN
      double precision,parameter :: a(3)  = (/ 0.97d0,0.750d0,0.75d0 /)
      double precision,parameter :: ab(3) = (/ 1.51d0,1.3d0,1.30d0 /)
