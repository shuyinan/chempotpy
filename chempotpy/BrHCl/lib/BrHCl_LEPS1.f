...
C   Sato Parameters:  J. A. Kaye and A. Kuppermann                              
C                     Chem. Phys. Lett. 92, 574 (1982)                          
C
...
C        EASYBC and EASYAC represent the energies in the HCl and the ClBr       
...
C                                                                               
 100  FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',                
     *      //,1X,T5,'BrHCl LEPS potential energy surface',                     
     *      //,1X,T5,'Parameters:',                                             
...
C                                                                               
         ...
         DATA Z/ 0.154D0, 0.154D0, 0.154D0/                                     
C                                                                               
         END                                                                    
C                                                                               
C*****                                                                          
