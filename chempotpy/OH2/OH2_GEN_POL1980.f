...
C                                                                               
C      WRITE(NFLAG(18),630) (REQ(IT), IT = 1,3)                                  
C      WRITE(NFLAG(18),631) DE                                                   
C      WRITE(NFLAG(18),632) BETA                                                 
C      WRITE(NFLAG(18),635) RBB                                                  
C      WRITE(NFLAG(18),633) A                                                    
C      WRITE(NFLAG(18),634) GAMMA                                                
C                                                                               
...
C      WRITE(NFLAG(18),121)D1INF,R1EINF,B1INF,D2INF,R2INF,B2INF,A1INF,A2I        
C     NF                                                                        
C      WRITE(NFLAG(18),123)R1S,R2S,VSP,ALPH1,ALPH2                               
C                                                                               
C      IF(IAYES.NE.0) WRITE(NFLAG(18),133)                                       
C      IF(IAYES.EQ.0) WRITE(NFLAG(18),131)                                       
C                                                                               
...
C                                                                               
C      WRITE(NFLAG(18),111)NPHI,NV                                               
C      WRITE (NFLAG(18), 700)                                                    
C                                                                               
C      DO 20 I = 1,NPHI                                                          
C          WRITE(NFLAG(18),103)I,PHI(I),(BSP(I,J),CSP(I,J),J=1,NV)               
C  20  CONTINUE                                                                  
                                                                                
C      WRITE (NFLAG(18), 701)                                                    
                                                                                
C      DO 22 I=1,2                                                               
C         K = I + NPHI                                                           
C         WRITE(NFLAG(18),105)K,(CSP(K,J),J=1,NV)                                
C  22  CONTINUE                                                                  
C                                                                               
      D1 = BSP(1,1)                                                             
      D2 = BSP(NPHI,1)                                                          
