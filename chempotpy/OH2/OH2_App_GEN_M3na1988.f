...
C   Common name:     M3na, symmetrized M2 potential                             
...
C                                                                               
      PARAMETER (ONE = 1.0D0)                                                   
C                                                                               
      COMMON /PRECM/  DE1(3),DE2(3),DCOSDR(3),DFDR(3),                          
     +                   A2,ASQ,IOPSW                                           
C                                                                               
...
C                                                                               
      SUBROUTINE PREPOT2                                                        
C                                                                               
C   The subprogram PREPOT2 determines the bending correction.                   
C                                                                               
...
C   PREPOT22 do not need to be called in the MAIN program.                      
C                                                                               
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)                                       
C                                                                               
      CHARACTER*75 REF(5)                                                       
...
C                                                                               
     ...
     *          WRITE (NFLAG(18), 6601) R(1), R(2), R(3), DR1, ALPH1            
            T1 = EXP(-DR1*ALPH1)                                                
            T2 = -ALPH1*T1                                                      
C                                                                               
...
C                                                                               
     ...
     *       WRITE (NFLAG(18), 6600) R(1), R(2), R(3), RR, ANGLE, DIS,          
     +                          REQ2, BET                                       
         DELR = RR - REQ2                                                       
         T1 = EXP(BET*DELR)                                                     
         T2 = 1.0D0 - T1                                                        
...
C                                                                               
C   Output from this subprogram is written to UNIT NFLAG(18)                    
C                                                                               
C *****  USER NOTES  *****                                                      
C                                                                               
