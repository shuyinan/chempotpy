...
C         This potential requires three data files (ch4f-so.inc, ch4f-so.dat,
C         and CONST-so), which may be downloaded along with the main subroutine
C         tarred together as the file ch4f-so.tar.
C
c**************************************************************************

      SUBROUTINE SURF(V, COORD, DX, N3TM, PATH)
C
C              CH5, see  Espinosa-Garcia, J.; Corchado, J.C. 
...
c
       file_path1 = trim(path)//"/CH4F/CONST-so"
