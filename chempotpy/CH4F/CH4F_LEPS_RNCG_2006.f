...
C   Reference:     J. Espinosa-Garcia, J.L. Bravo and C. Rangel
C                  J.Phys.Chem. A, 111, 2761 (2007).
C
      SUBROUTINE POT
C
...
C
       ...
       REF(2)='Unpublished results, 2006.'
C
      INDEXES(1) = 1
      INDEXES(2) = 6
      INDEXES(3) = 1
...
C
      ...
      DATA NATOMS /6/
       ...
       DATA aphi    /   1.3587903d0/
       DATA bphi    /   0.2006638d0/
