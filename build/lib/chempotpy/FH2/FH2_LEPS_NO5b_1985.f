...
C                                                                               
C     COMMON/TRANS/E3C,Z                                                        
C                                                                               
C      LOGICAL LCOL, LDERIV, LZERO                                              
         COMMON /PRECM/ Z(3),Q(3),XJ(3),DQ(3,3),DJ(3,3),                        
     +                  DZ(3,3),RR(3),A1,A2,A,B,C,D,F,G,                        
     +                  BET,BETP,ZHH0,ZHHST,ZA,ZB,ZC,ZD,ZE,                     
     +                  RFH0,DEG1,DEG2,DEG3,DEG4,DEG3P,                         
     +                  C1,C2,C3,C4,C5,C6,C3C,ALF,ALFP,ALFT,                    
...
600   FORMAT (/,2X,T5,'PREPOT has been called for the FH2 ',                    
     ...
     *        /,2X,T5,'potential energy surface no. 5B',                        
...
610   FORMAT (/,2X,T5,'HH Sato parameter fit',                                  
     ...
     * /,2X,T5,'A',   T10,'=',T12,1PE13.5, T40,'RFH0',T46,'=',T48,E13.5,        
     * /,2X,T5,'A1',  T10,'=',T12,E13.5, T40,'ZA', T46,'=',T48,1PE13.5,         
     * /,2X,T5,'A2',  T10,'=',T12,E13.5, T40,'ZB', T46,'=',T48,E13.5,           
     * /,2X,T5,'B',   T10,'=',T12,E13.5, T40,'ZC', T46,'=',T48,E13.5,           
     * /,2X,T5,'C',   T10,'=',T12,E13.5, T40,'ZD', T46,'=',T48,E13.5,           
     * /,2X,T5,'D',   T10,'=',T12,E13.5, T40,'ZE',T46,'=',T48,E13.5,            
...
C    FIRST COMPUTE Z(1) AS A FUNCTION OF RR(1)   DZ1R1 IS THE DERIVATIVE        
C    OF Z(1)  W.R.T RR(1).                                                      
C                                                                               
      T = EXP(-ZC*(RR(1)-RFH0)**2)                                              
      Z(1) = ZA + ZB*T                                                          
      DZ1R1 = -2.0D0*ZB*ZC*(RR(1)-RFH0)*T                                       
      T = A * (RR(2) - B)                                                       
...
C                                                                               
         ZPHI = ZD*SINP2 + ZE*SINP2*SINP2                                       
         TEM = 2.0D0*SINPHI*COSPHI                                              
         DZPHI = (ZD+2.0D0*ZE*SINP2)*TEM                                        
C                                                                               
...
C   Z(1) HAS ONLY A RR(1) DEPENDENCE (DZ1R1)                                    
C                                                                               
            DZ(1,1) = SCALE1 * (T2 * RR(1) + DZPHI * DPHI1)  +  DZ1R1           
...
C                                                                               
     ...
     +      0.0D0,0.2D0/                                                        
      DATA BET,BETP,ZHH0,ZHHST                                                  
     +     /-0.101168D0,-0.46183D0,0.120D0,0.23107D0/                           
      DATA ZA,ZB,ZC,ZD,ZE                                                       
     +     /0.175D0,-0.0437D0,0.5D0,0.07528D0,                                  
     +     -0.0446406D0/                                                        
      DATA RFH0/2.77989D0/                                                      
     ...
     +     /0.211673D0,0.18D0,0.078D0,2.14D0,                                   
     +      0.95D0,0.48D0/                                                      
C                                                                               
         END                                                                    
C                                                                               
