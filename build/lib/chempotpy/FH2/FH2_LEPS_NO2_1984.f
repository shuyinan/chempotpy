...
C   Common name:     no. 2                                                      
C   Reference:       D. G. Truhlar, B. C. Garrett, and N. C. Blais              
...
C   The potential parameters are included in data statements and in the         
C   block data subprogram PTPACM.                                               
...
C                                                                               
         ...
         COMMON /Z3CM/  Z(3)                                                    
         COMMON /PRECM/  D(3),RE(3),BETA(3),ZPO(3),OP3Z(3),ZP3(3),              
     +                   TZP3(3),TOP3Z(3),DO4Z(3),B(3),                         
     +                   X(3),COUL(3),EXCH(3)                                   
C                                                                               
...
22           CONTINUE                                                           
         ENDIF                                                                  
         ENGYGS = ENGYGS + COUL(1) + COUL(2) + COUL(3) +                        
     +            EZERO(1) - ANUZERO                                            
C                                                                               
C                                                                               
         IF (DEG.LE.DEG1) THEN                                                  
