...
c  maxatom --- maximal number of atoms
      ...
      dimension fcn(maxatom,maxatom),c(30)
      ...
      parameter(autoang=0.529177249d0)
        ...
        xk1= 3.77222765021983397
        xk2= 0.254059599413776260
        xk3= 3.71309233023937502
        au23= 0.679003419638495420

        g1= 0.431827063996091831
        du2= 0.829008304836345911
        gu2= 0.793888617489008297
        gzero= 10.9679042501221300
        g2= 6.49902296042989747/autoang

        deb= 1.67059110893991192/autoev
        reb= 5.13663898387884643
        a1b= 1.21104054714215925
        a2b= 0.633317049340498373
        a3b= 0.155984367366878374
        au2b= 0.216047874938935042
...
c potential, includes cutoff
      ...
      v=v-tmp+tmpb*(fs(i,j)-fcn(i,j)+fs(i,j)*fcn(i,j))
    1 continue
