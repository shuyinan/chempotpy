...
C   Common name:     CHC7M10
C   Reference:       unpublished
C   Cross reference: M. M. Kreevoy, D. Ostovic, 
...
600   FORMAT(/,1X,'*****','Potential Energy Surface',1X,'*****',
     *      //,1X,T5,'Al + LC CHC7M10 potential energy surface',
     *      //,1X,T5,'Parameters:',
...
900   FORMAT(/,1X,T5,'Error: POT has been called with NDER = ', I5,
     *       /,1X,T12,'only first derivatives, NDER = 1, are ',
...
C   kcal/mol, and the lengths are in Angstroms.
         DATA DE/ 83.00000D0, 73.00000D0, 80.00000D0/
         DATA RE/ 1.10000D0, 1.10000D0, 1.54000D0/
         DATA BETA/ 2.04010D0, 2.17500D0, 2.07800D0/
