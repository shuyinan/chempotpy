...
C                                                                               
C   Note: This surface differs from the original BrHCl surface in that          
C         the Sato parameters have been interchanged.  The reference for the    
C         original Sato parameters is :                                         
C                     V. K. Babamov, V. Lopez, and R. A. Marcus                 
...
C   energy of the Cl "infinitely" far from the BrH diatomic, with the           
C   BrH diatomic at its equilibrium geometry.  Similarly, the term EASYBC       
C   and EASYAC are for the HCl and BrCl asymptotic valleys, respectively.       
...
C   infinitely far from the equilibrium HCl diatomic.                           
C                                                                               
...
C                                                                               
 ...
 1111    FORMAT(2X,'STOP. NUMBER OF ATOMS EXCEEDS ARRAY DIMENSIONS')            
      ...
      END IF                                                                    
C                                                                               
C         WRITE (NFLAG(18), 100) DE, RE, BETA, Z                                 
C                                                                               
100   FORMAT (/, 2X, T5, 'PREPOT has been called for BrHCl ',                   
     *                   'potential surface no. 2',                             
     *        /, 2X, T5, 'extended LEPS functional form',                       
     *        //, 2X, T5, 'Potential energy surface parameters:',               
     *        /, 2X, T5, 'Bond', T46, 'Br-H', T58, 'H-Cl', T68, 'Cl-Br',        
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='D. J. Douglas, J. C. Polanyi, and J. J. Sloan'                   
       REF(2)='Chem. Phys. 13, 15 (1976). [Morse Parameters]'                   
       REF(3)='P. J. Kuntz, E. M. Nemth, J. C. Polanyi,'                        
       REF(4)='S. D. Rosner, and C. E. Young'                                   
...
C                                                                               
         DATA DE/ 90.24D0, 106.4D0, 52.09D0/                                    
         DATA RE/ 1.414D0, 1.275D0, 2.136D0/                                    
         DATA BETA/ 1.851D0, 1.867D0, 1.923D0/                                  
         DATA Z/ 0.00D0, 0.02D0, 0.02D0/                                        
C                                                                               
         END                                                                    
C                                                                               
C*****                                                                          
