...
c Common name:     JOT-II                                                       
c Reference:       N. Jonathon, S. Okuda, and D. Timlin, Mol. Phys.             
c                  24, 1143 (1972).                                             
C
...
c           R(3) = R(H-F')                                                      
c                                                                               
c The zero of energy for this potential occurs when the H atom is               
c "infinitely" far from the F2 diatom, and the F2 diatom is at                  
...
C                                                                               
C      dimension de(3),re(3),b(3),s(3),hde(3),hpf(3),pfs(3),pft(3)              
C      save de,re,b,s,cevau,canau                                               
c                                                                               
