...
C   Common name:
C
C   References:    J. C. Corchado, J. Espinosa-Garcia, O. Roberto-Neto, Y.-Y. Chuang,
C                  and D. G. Truhlar, J. Phys. Chem., Vol. 102, p. 4899, 1998.
C
C
      SUBROUTINE POT                                                            
C                                                                               
C System: CH4+O based on the surface by                                         
C         Jordan and Gilbert, JCP, 102, 5669 (1995).                            
C         new version of the surface by Espinosa and Corchado                   
C         (JPC, 102, 4899 (1998))                                               
C         Espinosa and Corchado, April 1999.                                    
C                                                                               
...
c                                                                               
       en=vstr+vop+vip                                                          
C                                                                               
C 0.03812 factor from 10(5) j/mol to au                                         
C                                                                               
       en = en*0.03812D0                                                        
       ENGYGS = en                                                              
C                                                                               
      ...
      IF(NDER.NE.0) THEN                                                        
C                                                                               
C  copy the pdots calculated using MARINER code to the                          
C  appropriate elements in dv. dx in POLYRATE.                                  
C                                                                               
C  0.0201723 factor from 10(5)j/mol/A to hartrees/bohr                          
C                                                                               
         do ind=1,3                                                             
         ...
         enddo                                                                  
C         do ind=1,3                                                            
C            DGSCART(1,ind)=pdot(nh(4,ind))*0.0201723d0                         
C            DGSCART(2,ind)=pdot(nc(ind))*0.0201723d0                           
C            DGSCART(3,ind)=pdot(nh(1,ind))*0.0201723d0                         
C            DGSCART(4,ind)=pdot(nh(2,ind))*0.0201723d0                         
C            DGSCART(5,ind)=pdot(nh(3,ind))*0.0201723d0                         
C            DGSCART(6,ind)=pdot(nhb(ind))*0.0201723d0                          
C         enddo                                                                 
C                                                                               
         CALL RTOCART                                                           
         CALL DEDCOU                                                            
...
c                                                                               
     ...
     *                 +(vjbh(i)-vjch(i))**2)*0.5d0)                            
         vstr=vstr+vq(i)+vj(i)                                                  
       enddo                                                                    
C      write (23,*) "stretch C-H"                                               
c      write (23,*) espi1,espi3                                                 
C      write (23,*) "stretch Cl-H"                                              
c      write (23,*) espa1,espa3                                                 
c                                                                               
...
C                                                                               
       ...
       END DO                                                                   
C                                                                               
       REF(1)='Espinosa and Corchado,'                                          
       REF(2)='J. Phys. Chem. 102, 4899(1998)'                                  
C                                                                               
      INDEXES(1) = 1                                                            
      INDEXES(2) = 6                                                            
      INDEXES(3) = 1                                                            
