...
C   Common name:      SiH5-2
C   Notes:
C
C   References:  J. Espinosa-Garcia, J. Sanson, J. C. Corchado, J. Chem. Phys.
...
C
       ...
       END DO
C
       REF(1)='J. Espinosa-Garcia, J. Sanson, and J. C. Corchado'
       REF(2)='J. Chem. Phys., Vol. 109, p. 466, 1998'
C
      INDEXES(1) = 1
      INDEXES(2) = 14
      INDEXES(3) = 1
